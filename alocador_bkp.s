...
iniciaAlocador:
	...
	addq $TAM_ALOC, %rax			# tamanho a ser alocado (1024)
	movq %rax, topo					# topo = inicio + alocador

	movq %rax, %rdi					# aloca o espaco reservado (1024)
	movq $12, %rax
	syscall
	...
	jg fim_aloca_mem			
		...
		jne fim_if_while_aloca_mem
			...
			jle sem_espaco	
				...
				addq $16, %r13		# r13 = sobra + 16
				addq %r13, %rbx		# rbx = topo - solicitado (fim da heap)
